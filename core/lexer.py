...
class Lexer:
    def __init__(self, text: str):
        ...
        self.token_specification = [
            ...
            (TokenType.ASSIGN_ADD, r'\+\='),
            (TokenType.ASSIGN_SUB, r'-='),
            (TokenType.ASSIGN_MULT, r'\*='),
            (TokenType.ASSIGN_DIV, r'\/='),
            (TokenType.ASSIGN_MOD, r'%='),
            (TokenType.ASSIGN_LEFT_SHIFT, r'<<='),
            (TokenType.ASSIGN_RIGHT_SHIFT, r'>>='),
            (TokenType.ASSIGN_BIT_AND, r'&='),
            (TokenType.ASSIGN_BIT_OR, r'\|='),
            (TokenType.ASSIGN_BIT_XOR, r'\^='),
